...
class Trans2Net(BaseModel):
    ...
    def train_parameters(self, cfg):
        ...
        for epoch in range(cfg.START_EPOCH, total_epoch + 1):
            ...
            # if cfg.EVALUATE:
            if (epoch % self.cfg.EVALUATE_FREQ == 0 or epoch > total_epoch - 10 or epoch == total_epoch) and cfg.EVALUATE:
    ...
    def print_evaluate_results(self):
        if self.cfg.TASK_TYPE == 'segmentation':
            ...
            print('Mean Acc Top1 MLP: <{mean_acc:.3f}> '.format(mean_acc=self.loss_meters[
                                                                        'VAL_CLS_MEAN_ACC_MLP'].val * 100))
